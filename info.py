...
BOT_TOKEN = environ.get('BOT_TOKEN', '6139751568:AAG5tJn93-WRLLKTMQaX0-NcbwCRRIWsCt8')
...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1001763188473 -1001893475548').split()]
